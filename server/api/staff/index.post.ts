...
export default defineEventHandler(async (event) => {
  ...
  const { data, error } = await supabase
    ...
    .select('id, name, role, active, email, members_access, staff_access, schedule_access, orders_access, bookings_access, company_access, products_access, analytics_access, created_at')
    .single()
